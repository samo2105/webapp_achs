...
ActiveRecord::Schema.define(version: 2019_09_27_234748) do
  ...
  create_table "user_to_dos", force: :cascade do |t|
    t.integer "user_id", null: false
    t.integer "tag_id", null: false
    t.string "name"
    t.string "detail"
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["tag_id"], name: "index_user_to_dos_on_tag_id"
    t.index ["user_id"], name: "index_user_to_dos_on_user_id"
  end
  ...
  add_foreign_key "user_to_dos", "users"
end
